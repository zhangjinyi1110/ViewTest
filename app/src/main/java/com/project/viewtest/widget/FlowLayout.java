...
//            Log.i(TAG, "onMeasure: w/h:" + view.getMeasuredWidth() + "/" + view.getMeasuredHeight()
//                    + "ll/lr:" + layoutParams.leftMargin + "/" + layoutParams.rightMargin
//                    + "ls/le:" + layoutParams.getMarginStart() + "/" + layoutParams.getMarginEnd()
//                    + "lt/lb:" + layoutParams.topMargin + "/" + layoutParams.bottomMargin
//                    + "ps/pe:" + view.getPaddingStart() + "/" + view.getPaddingEnd()
//                    + "pt/pb:" + view.getPaddingTop() + "/" + view.getPaddingBottom()
//                    + "pl/pr:" + view.getPaddingLeft() + "/" + view.getPaddingRight());
            ...
            Log.i(TAG, "onMeasure: " + measureWidth);
